    ...
    >
      ...
      <template v-else>
        <q-list bordered separator class="full-width">
          <q-item v-for="game in filteredGiochi" :key="game.id" clickable @click="showGameDetails(game)">
            <q-item-section avatar>
              <q-img :src="getImageUrl(game.copertina)" alt="Copertina gioco" style="width: 50px; height: 50px; object-fit: cover;" />
            </q-item-section>
            <q-item-section>
...
const columnsGiochi = [
  { name: 'copertina', label: 'Copertina', field: 'copertina', align: 'left', style: 'width: 50px;' },
...
export default defineComponent({
  ...
  setup() {
    ...
    const filteredGiochi = computed(() => {
      ...
      return giochi.value.filter(gioco =>
